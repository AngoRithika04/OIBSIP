...
{  
    ...
    {     
        ...
        setTitle("Online Exam Login Page ");         
    }   
...
{  
    ...
    {          
        ...
        if(e.getActionCommand().equals("Review later"))  
        {  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText(" 1) Which of the following is not a Java features? ");  
            jb[0].setText("Dynamic");jb[1].setText("Interpreter");jb[2].setText("Pointers");jb[3].setText("OOPS");   
        }  
        if(current==1)  
        {  
            l.setText(" 2) What is used to find and fix bugs in the Java programs? ");  
            jb[0].setText("JVM");jb[1].setText("JRE");jb[2].setText("JDK");jb[3].setText("JDB");  
        }  
        if(current==2)  
        {  
            l.setText(" 3) What does the expression float a = 35 / 0 return? ");  
            jb[0].setText("0");jb[1].setText("Not a Number");jb[2].setText("Infinity");jb[3].setText("Run time exception");  
        }  
        if(current==3)  
        {  
            l.setText(" 4) Which of the following is an immediate subclass of the Panel class? ");  
        ...
        {  
            ...
            jb[0].setText("for(;;)");jb[1].setText("for()i=0;j<1;i--");jb[2].setText("for(int=0;i++)");jb[3].setText("All of the above");  
        }  
        if(current==6)  
        {  
            l.setText(" 7)Which keyword is used for accessing the features of a package? ");  
            jb[0].setText("package");jb[1].setText("import");jb[2].setText("extends");jb[3].setText("export");  
        }  
        if(current==7)  
        {  
            l.setText(" 8) Which of the following is a reserved keyword in Java? ");  
